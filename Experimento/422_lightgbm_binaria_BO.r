...
PARAM$semilla_primigenia <- 173717
PARAM$experimento <- "HT4220"

PARAM$input$dataset <- "/home/mili_irusta/buckets/b1/datasets/dmeyf2024/Experimento/dataset_con_variables_estacionales_limpio.csv.gz"
PARAM$input$training <-  c(202012, 202011, 202010, 202009, 202008) # los meses en los que vamos a entrenar
