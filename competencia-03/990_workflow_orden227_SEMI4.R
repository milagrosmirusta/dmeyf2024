...
envg$EXPENV$datasets_dir <- "~/buckets/b1/datasets/competencia_03.csv.gz"
...
TS_strategy_base8 <- function( pinputexps )
{
  ...
  param_local$final_train$undersampling <- 0.01
  param_local$final_train$clase_minoritaria <- c( "BAJA+1", "BAJA+2")
  param_local$final_train$training <-  c(
    ...
    201909, 201908, 201907, 201906, 201902, 201901
...
KA_evaluate_kaggle_semillerio <- function( pinputexps )
{
  ...
  param_local$envios_desde <- 10050L
