...
envg$EXPENV$datasets_dir <- "~/buckets/b1/datasets/competencia_02.csv.gz"
envg$EXPENV$messenger <- "~/install/zulip_enviar.sh"

envg$EXPENV$semilla_primigenia <- 173717
...
DT_incorporar_dataset <- function( arch_dataset )
{
  ...
  param_local$meta$script <- "/Segunda_competencia/wf-etapas/z1101_DT_incorporar_dataset.r"
...
CA_catastrophe_base <- function( pinputexps, metodo )
{
  ...
  param_local$meta$script <- "/Segunda_competencia/wf-etapas/z1201_CA_reparar_dataset.r"
...
FEintra_manual_base <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/Segunda_competencia/wf-etapas/z1301_FE_intrames_manual.r"
...
DR_drifting_base <- function( pinputexps, metodo)
{
  ...
  param_local$meta$script <- "/Segunda_competencia/wf-etapas/z1401_DR_corregir_drifting.r"
...
FEhist_base <- function( pinputexps)
{
  ...
  param_local$meta$script <- "/Segunda_competencia/wf-etapas/z1501_FE_historia.r"
...
)
{
  ...
  param_local$meta$script <- "/Segunda_competencia/wf-etapas/z1311_FE_rfatributes.r"
...
CN_canaritos_asesinos_base <- function( pinputexps, ratio, desvio)
{
  ...
  param_local$meta$script <- "/Segunda_competencia/wf-etapas/z1601_CN_canaritos_asesinos.r"
...
TS_strategy_base8 <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/Segunda_competencia/wf-etapas/z2101_TS_training_strategy.r"
...
HT_tuning_base <- function( pinputexps, bo_iteraciones, bypass=FALSE)
{
  ...
  param_local$meta$script <- "/Segunda_competencia/wf-etapas/z2201_HT_lightgbm_gan.r"
...
FM_final_models_lightgbm <- function( pinputexps, ranks, qsemillas )
{
  ...
  param_local$meta$script <- "/Segunda_competencia/wf-etapas/z2301_FM_final_models_lightgbm.r"
...
SC_scoring <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/Segunda_competencia/wf-etapas/z2401_SC_scoring_lightgbm.r"
...
KA_evaluate_kaggle <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/Segunda_competencia/wf-etapas/z2601_KA_evaluate_kaggle.r"
